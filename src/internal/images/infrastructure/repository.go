...
func (r *ImageRepository) CreateImage(ctx context.Context, userID uuid.UUID, name string) (*domain.Image, error) {
	slog.Info("DB query", "operation", "INSERT", "table", "images", "parameters", fmt.Sprintf("user_id: %s, name: %s", userID, name))
...
func (r *ImageRepository) GetImageByUserIDandName(
	...
	slog.Info("DB query", "operation", "SELECT", "table", "images", "parameters", fmt.Sprintf("user_id: %s, name: %s", userID, name))
...
func (r *ImageRepository) GetImagesByUserID(
	...
	slog.Info("DB query", "operation", "SELECT", "table", "images", "parameters", fmt.Sprintf("user_id: %s", userID))
...
func (r *ImageRepository) UpdateImage(ctx context.Context, id uuid.UUID) error {
	slog.Info("DB query", "operation", "UPDATE", "table", "images", "parameters", fmt.Sprintf("id: %s", id))
...
func (r *ImageRepository) DeleteImage(ctx context.Context, id uuid.UUID) error {
	slog.Info("DB query", "operation", "DELETE", "table", "images", "parameters", fmt.Sprintf("id: %s", id))
...
func (r *ImageRepository) GetAllImages(ctx context.Context, page, limit *int) ([]*domain.Image, int, error) {
	slog.Info("DB query", "operation", "SELECT", "table", "images")
